...
response1 = WS.sendRequest(findTestObject('country info soap service/git capital', [('countrycode') : countrycode]))

WS.verifyElementText(response1, 'CapitalCityResponse.CapitalCityResult', capital)

response2 = WS.sendRequest(findTestObject('country info soap service/get currency', [('countrycode') : countrycode]))
